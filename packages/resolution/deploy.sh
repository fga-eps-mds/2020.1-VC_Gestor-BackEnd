...
IMAGE="guilhermeaguiar/resolution"                             # Docker image
...
ssh -i "deploy_rsa" ubuntu@ec2-18-191-150-245.us-east-2.compute.amazonaws.com  'bash -s' < docker_deploy.sh ${IMAGE}:${GIT_VERSION}